...
export const SCOPE3_CATEGORIES: Scope3Category[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { id: "distance-based", label: "Distance-based", detail: "Distance by mode. Air also needs haul length and cabin class." },
  ...
  },
  {
    ...
    methods: [
      { id: "fuel-based", label: "Fuel-based", detail: "Fuel consumed by commuting group." },
      { id: "distance-based", label: "Distance-based", detail: "Distance and travel mode from a survey or from totals you enter." },
...
export const EMISSION_FACTORS: EmissionFactor[] = [
  ...
  { id: "c6-air-domestic-economy", factor: "0.246", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Domestic economy", categories: [6] },
  { id: "c6-air-domestic-premium", factor: "0.369", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Domestic premium economy", categories: [6] },
  { id: "c6-air-domestic-business", factor: "0.369", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Domestic business", categories: [6] },
  { id: "c6-air-domestic-first", factor: "0.492", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Domestic first", categories: [6] },
  { id: "c6-air-short-economy", factor: "0.156", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Short-haul economy", categories: [6] },
  { id: "c6-air-short-premium", factor: "0.234", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Short-haul premium economy", categories: [6] },
  { id: "c6-air-short-business", factor: "0.234", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Short-haul business", categories: [6] },
  { id: "c6-air-short-first", factor: "0.312", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Short-haul first", categories: [6] },
  { id: "c6-air-long-economy", factor: "0.191", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Long-haul economy", categories: [6] },
  { id: "c6-air-long-premium", factor: "0.306", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Long-haul premium economy", categories: [6] },
  { id: "c6-air-long-business", factor: "0.555", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Long-haul business", categories: [6] },
  { id: "c6-air-long-first", factor: "0.765", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Long-haul first", categories: [6] },
  { id: "c6-rail", factor: "0.035", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "National rail", categories: [6] },
  { id: "c6-car", factor: "0.171", unit: "kg CO2e / km", source: "DEFRA", year: "2024", region: "United Kingdom", type: "Average car", categories: [6] },
  { id: "c6-taxi", factor: "0.208", unit: "kg CO2e / km", source: "DEFRA", year: "2024", region: "Global", type: "Regular taxi", categories: [6] },
  { id: "c6-bus", factor: "0.108", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Average coach / bus", categories: [6] },
  { id: "c6-ferry", factor: "0.113", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Average ferry", categories: [6] },
  { id: "c6-jet", factor: "2.54", unit: "kg CO2e / litre", source: "DEFRA", year: "2024", region: "Global", type: "Jet kerosene", categories: [6] },
  { id: "c6-petrol", factor: "2.31", unit: "kg CO2e / litre", source: "DEFRA", year: "2024", region: "Global", type: "Petrol", categories: [6] },
  { id: "c6-diesel", factor: "2.68", unit: "kg CO2e / litre", source: "DEFRA", year: "2024", region: "Global", type: "Diesel", categories: [6] },
  { id: "c6-electric", factor: "0.71", unit: "kg CO2e / kWh", source: "CEA", year: "2024", region: "India", type: "Grid electricity", categories: [6] },
  { id: "eeio-travel", factor: "0.18", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Travel spend", categories: [6] },
  { id: "c6-spend-air", factor: "0.42", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Air travel spend", categories: [6] },
  { id: "c6-spend-rail", factor: "0.07", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Rail travel spend", categories: [6] },
  { id: "c6-spend-car", factor: "0.20", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Car hire spend", categories: [6] },
  { id: "c6-spend-taxi", factor: "0.22", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Taxi spend", categories: [6] },
  { id: "c6-spend-bus", factor: "0.12", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Bus / coach spend", categories: [6] },
  { id: "c6-spend-ferry", factor: "0.16", unit: "kg CO2e / USD", source: "EEIO", year: "2023", region: "Global", type: "Ferry spend", categories: [6] },
  { id: "c7-car", factor: "0.171", unit: "kg CO2e / km", source: "DEFRA", year: "2024", region: "Global", type: "Average car (unknown fuel)", categories: [7] },
  { id: "c7-two-wheeler", factor: "0.114", unit: "kg CO2e / km", source: "DEFRA", year: "2024", region: "Global", type: "Average motorcycle", categories: [7] },
  { id: "c7-bus", factor: "0.108", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "Average local bus", categories: [7] },
  { id: "c7-metro", factor: "0.035", unit: "kg CO2e / pkm", source: "DEFRA", year: "2024", region: "Global", type: "National rail / metro", categories: [7] },
  { id: "c7-walk-cycle", factor: "0", unit: "kg CO2e / km", source: "GHG Protocol", year: "2024", region: "Global", type: "Walking and cycling", categories: [7] },
  { id: "c7-wfh", factor: "0", unit: "kg CO2e / km", source: "GHG Protocol", year: "2024", region: "Global", type: "No commute", categories: [7] },
